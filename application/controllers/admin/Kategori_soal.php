...
class Kategori_soal extends Super //class mengikuti nama file. diawali dengan huruf besar
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "kategori_soal"; //nama tabel sesuai dengan nama yg ada di database
        $this->active_id_menu = "kategori soal";
        $this->nama_view      = "Kategori soal"; //tampilan untuk di view
        $this->status         = true; 
