...
class Dataguru extends Super //class mengikuti nama file. diawali dengan huruf besar
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "guru"; //nama tabel sesuai dengan nama yg ada di database
        $this->active_id_menu = "Data Guru";
        $this->nama_view      = "Data Guru"; //tampilan untuk di view
        $this->status         = true; 
