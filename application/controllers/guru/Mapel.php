...
class Mapel extends Super //class mengikuti nama file. diawali dengan huruf besar
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "mapel"; //nama tabel sesuai dengan nama yg ada di database
        $this->active_id_menu = "mata pelajaran";
        $this->nama_view      = "mata pelajaran"; //tampilan untuk di view
        $this->status         = true; 
