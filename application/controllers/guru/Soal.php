...
class Soal extends Super //class mengikuti nama file. diawali dengan huruf besar
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "soal"; //nama tabel sesuai dengan nama yg ada di database
        $this->active_id_menu = "Soal";
        $this->nama_view      = "Soal"; //tampilan untuk di view
        $this->status         = true; 
    ...
    function index(){
            ...
            **/
            ...
            $this->crud->set_relation('id_kategori','kategori_soal','kategori');
