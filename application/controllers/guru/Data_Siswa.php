...
class Data_Siswa extends Super //class mengikuti nama file. diawali dengan huruf besar
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "siswa"; //nama tabel sesuai dengan nama yg ada di database
        $this->active_id_menu = "Data Siswa";
        $this->nama_view      = "Data Siswa"; //tampilan untuk di view
        $this->status         = true; 
