...
class Kelas extends Super //class mengikuti nama file. diawali dengan huruf besar
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "kelas"; //nama tabel sesuai dengan nama yg ada di database
        $this->active_id_menu = "Kelas";
        $this->nama_view      = "Kelas"; //tampilan untuk di view
        $this->status         = true; 
